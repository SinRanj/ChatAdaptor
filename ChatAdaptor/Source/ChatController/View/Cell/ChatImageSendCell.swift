...
class ChatImageSendCell: ChatCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        sendImageView.identifier = "sendImageView"
        avatarView.identifier = "avatarView"
        bubleView.identifier = "bubleView"
        sendImageView.cornerRadius()
        ...
        constraintWithCustomMargin(view: sendImageView, left: 100, leftRelation: .greaterThanOrEqual, right: -10, top: 12, bottom: messageBottomConst, rightView: avatarView,width:200)
        constraintWithLeadingAndTrailing(view: bubleView, left: -4, right: 4, top: -4, bottom: 4, secondView: sendImageView)
        constraintWithLeadingAndTrailing(view: dateLabel, left: 0, right: 0, top: 0,topActive: false, bottom: 20, secondView: sendImageView)
